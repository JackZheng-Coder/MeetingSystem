...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            ...
            <a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete" lay-event="updatePwd">修改密码</a>
        </script>
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '<%=basePath%>user/my_update?id='+data.id,
                    end:function () {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['60%', '60%'],
                    content: '<%=basePath%>user/updatePwd',
                    end:function () {
                        window.location.reload();
                    }
                });
